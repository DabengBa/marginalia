...
from marginalia.llm.tagged_response import render_format_hint, render_sections_hint
...
CHUNK_SYSTEM = """You are Marginalia's document section indexer.
...
AGGREGATE_SYSTEM = """You are Marginalia's aggregate document indexer.
