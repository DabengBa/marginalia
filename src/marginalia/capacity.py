...
from marginalia.db.models import Conversation, File, Task
from marginalia.tasks.kinds import KIND_BULK_REPROCESS_FILES, KIND_INGEST_FILE
...
async def _lock_gate(db: AsyncSession, *, operation: str) -> None:
    ...
    await db.execute(
        ...
        {"capacity_key": f"marginalia-capacity:{operation}"},
    )
